...
#favourite apps
# ['org.gnome.Nautilus.desktop', 'brave-browser.desktop', 'torbrowser.desktop',
# 'qbittorrent-arnatious_qbittorrent.desktop', 'android-studio_android-studio.desktop', 'nvim_nvim.desktop',
# 'signal-desktop_signal-desktop.desktop', 'org.gnome.gitg.desktop', 'snap-store_ubuntu-software.desktop']
